...
import {
  ...
  CircularProgress, Divider, Alert, LinearProgress, Fade,
} from "@mui/material";
...
function MfaSetupPage() {
  ...
  const loadStatus = async () => {
    try {
      ...
      const res = await fetch(`${API_BASE}/mfa/status`, {
  ...
  const progressPercent = step === "backup" ? 100 : step === "scan" ? 50 : step === "intro" ? 25 : 0;

  if (step === "loading" || step === "preparing") {
    return (
      <DashboardLayout subtitle="Configurar Autenticación en Dos Pasos" decor="mfa">
        <Box sx={{ maxWidth: 480, mx: "auto", pt: 4 }}>
          <LinearProgress
            variant={step === "preparing" ? "indeterminate" : "determinate"}
            value={0}
            sx={{
              mb: 6, height: 4, borderRadius: 2,
              bgcolor: "#ECECEF",
              "& .MuiLinearProgress-bar": { bgcolor: "#680036", borderRadius: 2 },
            }}
          />
          <Box sx={{ textAlign: "center" }}>
            <CircularProgress sx={{ color: "#680036", mb: 2 }} />
            <Typography sx={{ color: "#77737A", fontSize: 14 }}>
              {step === "preparing" ? "Preparando configuración de seguridad..." : "Cargando..."}
            </Typography>
          </Box>
        </Box>
      </DashboardLayout>
  ...
  if (step === "enabled") {
    return (
      <DashboardLayout subtitle="Autenticación en Dos Pasos" decor="mfa">
        <Box sx={{ maxWidth: 520, mx: "auto" }}>
          <Fade in timeout={300}>
            <Paper elevation={0} sx={{ borderRadius: 3, border: "1px solid #ECECEF", overflow: "hidden" }}>
              <Box sx={{ p: 4, textAlign: "center" }}>
                ...
                <Typography sx={{ color: "#18151A", fontWeight: 700, mb: 1, fontSize: 20 }}>
                  MFA está activo
                </Typography>
                <Typography sx={{ color: "#77737A", fontSize: 13, mb: 3, lineHeight: 1.7, maxWidth: 380, mx: "auto" }}>
                  La autenticación en dos pasos está habilitada para tu cuenta. Cada inicio de sesión requiere tu contraseña y un código de la app autenticadora.
                </Typography>
                <Button variant="outlined" onClick={handleDisable} sx={{ color: "#ba1a1a", borderColor: "#ba1a1a", fontWeight: 600, borderRadius: 2, textTransform: "none", "&:hover": { borderColor: "#ba1a1a", bgcolor: "rgba(186,26,26,0.06)" } }}>
                  Desactivar MFA
                </Button>
              </Box>
            </Paper>
        ...
        <Box sx={{ maxWidth: 520, mx: "auto" }}>
          <LinearProgress
            ...
            sx={{
              ...
              bgcolor: "#ECECEF",
              "& .MuiLinearProgress-bar": { bgcolor: "#680036", borderRadius: 2, transition: "transform 0.6s cubic-bezier(0.4, 0, 0.2, 1)" },
            }}
          />
          <Fade in timeout={300}>
            <Box sx={{ textAlign: "center" }}>
              ...
              <Box sx={{ display: "inline-flex", alignItems: "center", gap: 1, bgcolor: "rgba(104,0,54,0.06)", px: 1.5, py: 0.5, borderRadius: 1, mb: 1.5 }}>
                <Typography sx={{ color: "#680036", fontWeight: 700, fontSize: 11 }}>Paso 1 de 2</Typography>
              </Box>
              ...
              <Typography sx={{ color: "#77737A", fontSize: 13, mb: 4, lineHeight: 1.7, maxWidth: 400, mx: "auto" }}>
                Añade una capa extra de seguridad a tu cuenta. Cada vez que inicies sesión, necesitarás tu contraseña <strong>y</strong> un código temporal generado por una app en tu celular.
              </Typography>
                ...
                <Fade in timeout={500}>
                  <Box sx={{ textAlign: "center", mb: 3 }}>
                    ...
                    <Box sx={{ p: 2, bgcolor: "#ffffff", borderRadius: 2, border: "2px solid #680036", display: "inline-block", boxShadow: "0 4px 20px rgba(104,0,54,0.1)" }}>
                      <img src={setupData.qrCode} alt="Código QR para MFA" style={{ width: 200, height: 200, display: "block" }} />
                    </Box>
  ...
  if (step === "backup") {
    return (
      <DashboardLayout subtitle="Autenticación en Dos Pasos Activada" decor="mfa">
        <Box sx={{ maxWidth: 520, mx: "auto" }}>
          <LinearProgress
            variant="determinate"
            value={100}
            sx={{
              mb: 3, height: 4, borderRadius: 2,
              bgcolor: "#ECECEF",
              "& .MuiLinearProgress-bar": { bgcolor: "#1f7a3f", borderRadius: 2 },
            }}
          />
          <Fade in timeout={300}>
            <Box sx={{ textAlign: "center" }}>
              ...
              <Box sx={{ display: "inline-flex", alignItems: "center", gap: 1, bgcolor: "#e8f7ed", px: 1.5, py: 0.5, borderRadius: 1, mb: 1.5 }}>
                <Typography sx={{ color: "#1f7a3f", fontWeight: 700, fontSize: 11 }}>Paso 2 de 2</Typography>
              </Box>
              ...
              <Button fullWidth variant="contained" onClick={handleFinish} disabled={!savedBackup}
                ...
                {savedBackup ? "Ir al perfil" : "Descarga o copia los códigos para continuar"}
              </Button>
